    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-indigo-900 py-6 sm:py-8 px-4">
      <div className="max-w-4xl mx-auto space-y-6 sm:space-y-8">
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-gray-300 text-base sm:text-lg">Manage your account settings and security</p>
        </div>

        {/* Settings Card */}
        <div className="bg-gray-800/30 backdrop-blur-xl rounded-3xl border border-gray-700/50 overflow-hidden shadow-2xl">

          {/* Card Header */}
          <div className="bg-gradient-to-r from-indigo-500/20 to-purple-500/20 p-6 border-b border-gray-700/50">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 bg-gradient-to-br from-indigo-500/20 to-purple-500/20 rounded-full flex items-center justify-center border border-indigo-500/30">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-4 py-3 pl-12 bg-gray-700/50 border border-gray-600 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:border-cyan-400 transition-all duration-300"
        ...
        <div className="bg-gray-800/30 backdrop-blur-xl rounded-3xl border border-gray-700/50 p-8 text-center">
          ...
          <p className="text-gray-400">Additional account settings and preferences will be available here.</p>
        </div>

...
const AdminSideBar = () => {
  const navItems = [
    ...
    { to: '/admin-dashboard/department', icon: Building2, label: 'Department' },
    { to: '/admin-dashboard/leaves', icon: Calendar, label: 'Leaves' },
    { to: '/admin-dashboard/attendance', icon: Clock, label: 'Attendance' },
    { to: '/admin-dashboard/attendance-reports', icon: CalendarDays, label: 'Attendance Reports' },
    { to: '/admin-dashboard/salaries', icon: Wallet, label: 'Salary' },
